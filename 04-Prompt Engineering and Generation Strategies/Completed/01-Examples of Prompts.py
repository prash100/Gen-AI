...
prompt = "Translate from English to French: " + input_text
print(prompt)
...
prompt = "Classify the given tweet into neutral, positive, or negative \n" \
    + "Tweet: " + tweet + "\n" + "Sentiment: " 
print(prompt)       
...
prompt = "Return a comma saperated list of named entities in the Text\n" + \
    "Text: " + text + "\n" + "Named Entities:"
print(prompt) 
