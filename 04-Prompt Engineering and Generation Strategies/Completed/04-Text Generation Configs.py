...
outputs = model.generate(**inputs, min_new_tokens=20, max_new_tokens=100, num_return_sequences=2)
print(outputs)
...
results = tokenizer.decode(outputs[1], skip_special_tokens=True)
print(results)
...
inputs = tokenizer(prompt, return_tensors="pt")
outputs = model.generate(**inputs, min_new_tokens=20, max_new_tokens=100, return_dict_in_generate=True)
print(outputs)                 
...
results = tokenizer.decode(outputs["sequences"][0], skip_special_tokens=True)
print(results)
...
inputs = tokenizer(prompt, return_tensors="pt")
outputs = model.generate(**inputs, min_new_tokens=20, max_new_tokens=100, 
...
my_configs = {"min_new_tokens":20, "max_new_tokens":100, "num_return_sequences":2}
model.generation_config.update(**my_configs)
print(model.generation_config)
