...
Story:
"""
result = pipe(prompt, num_beams=1, do_sample=False, temperature=1, top_p=1, max_new_tokens=100)
...
result = pipe(prompt, num_beams=5, do_sample=False, temperature=1, top_p=1, max_new_tokens=100)
print(result[0]["generated_text"])
...
result = pipe(prompt, num_beams=1, do_sample=True, temperature=1, top_p=1, max_new_tokens=100)
print(result[0]["generated_text"])
...
result = pipe(prompt, num_beams=1, do_sample=True, temperature=0.6, top_p=1, max_new_tokens=100)
print(result[0]["generated_text"])
...
result = pipe(prompt, num_beams=1, do_sample=True, temperature=0.6, top_p=0.2, max_new_tokens=100)
print(result[0]["generated_text"])
