...
# MAGIC %md
# MAGIC Q1: Perform text summarization on given customer comments.
# MAGIC 1. Do not use pipeline function
# MAGIC 2. Use Model Classes
# MAGIC 3. Apply sshleifer/distilbart-cnn-12-6 model from huggingface hub
...
results = summary_pipe([article_india, article_america])
print(results)
...
results = model.generate(input_ids=inputs.input_ids, attention_mask=inputs.attention_mask, min_length=20, max_length=50)
print(results)
...
summary_result = tokenizer.batch_decode(results, skip_special_tokens=True)
print(summary_result)

# COMMAND ----------

# MAGIC %md
# MAGIC Q2: Perform text summarization on given customer comments.
# MAGIC 1. Do not use pipeline function
