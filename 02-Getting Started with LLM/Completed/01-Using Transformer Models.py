...
# MAGIC %md
# MAGIC ####Using Transformer LLMs from Hugging Face Hub

# COMMAND ----------

# MAGIC %md
# MAGIC Q1: How to use a pre-trained transforamer AI model to summarize the provided text article.\
# MAGIC A couple of articles are given below
...
# MAGIC %md
# MAGIC Write code to summarize an article and show the result
...
# MAGIC %md
# MAGIC Q2: How to use t5-small model to summarize the provided text article.\
# MAGIC You can use articles provided above.
...
# MAGIC %md
# MAGIC Q3: How to use t5-small model to summarize the provided text article in less than 100 words.\
# MAGIC You can use articles provided above.
...
# MAGIC %md
# MAGIC Q4: How to use t5-small model to summarize the provided list of text articles in less than 100 words.\
# MAGIC The list of articles is provided
...
# MAGIC %md
# MAGIC Q5: Combine the articles with the above results and display them side by side.
