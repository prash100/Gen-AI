...
# MAGIC %md
# MAGIC 1.4 Get your questions ready
...
with ls.trace(project_name="Rag Routing", name="Python Question Chain",
              inputs={"question": question_py}) as rt:
    result = final_rag_chain.invoke({"question": question_py})
    print(result)
    rt.end(outputs={"solution": result})

# COMMAND ----------

import langsmith as ls

with ls.trace(project_name="Rag Routing", name="JS Question Chain",
              inputs={"question": question_py}) as rt:
    result = final_rag_chain.invoke({"question": question_js})
    print(result)
    rt.end(outputs={"solution": result})
